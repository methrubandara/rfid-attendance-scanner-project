...
if ($request !== 'class-view-force')
{
    if (empty($_SESSION['user_info']['email']))
    {
        ...
        $response = "Dumb stupid idiot hacker";
        die($response);
    }
                ...
                <wrapper id = "makeBlack">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-content">
                                    ...
                                    <!--
                                    <a href="classOverview.php">North Pole</a>
                                    <a href="classOverview.php">Santa's Workshop</a>
                                    <a href="classOverview.php">Santa's Sleigh</a>
                                    -->
                                </div>
                            </div>
                </wrapper>
...
foreach ($roster as $student)
{
    ...
    //         parseTime($student['image']);
    // echo "</div>";
    echo '</div>'; //3
    echo '<div class = "roster-expand"> ';
    echo '<div class = "expanded">';
    echo '<div>';
    //debugged previous line
    //echo '<img src = "https://aantex.com/wp-content/uploads/2020/06/macro-photography-of-jewel-beetle-on-green-leaf-1114318-1170x837.jpg">';
    //echo '<img class="fitBox" src= '.$student['image'].'>';
    //below is the working code, but christmas update is special
    //echo '<img class="fitBox" src= photos\\'.$student['student_id'].'.jpg>';
    //echo '<img class="fitBox" src= photos_christmas\\'.$student['student_id'].'_santa.png>';
    //valentines day!
    $id = $student['student_id'];
    echo '<img id = ' . $id . ' class="fitBox" src= photos_valentines\\' . $id . '_valentines.png>';
    //echo '<img id = '$student['student_id']' class="fitBox" src= photos_valentines\\'.$student['student_id'].'_valentines.png>';
    //echo '<script>';
    //echo 'document.getElementById("$student[\'student_id\']").style.filter="invert(100%)"';
    //echo '</script>'
    echo '</div>';
